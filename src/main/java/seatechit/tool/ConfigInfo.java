...
import seatechit.tool.hquanform.DMucHquan;
import seatechit.tool.hquanform1.DMucHquan1;
import seatechit.tool.signature.CertVerifier;
import seatechit.tool.taxCatalog.DMucDMuc;
import seatechit.tool.taxMessage.DMucTBao;
import seatechit.tool.taxMessageNtdt.DMucTBaoNtdt;
import seatechit.tool.taxRegistration.DMucDKy;
import seatechit.tool.taxmessagekdtt.DMucBKeKDTT;
import seatechit.tool.taxmessagekdtt.DMucTBaoKDTT;
import seatechit.tool.taxreturn.DMucTKhai;
import seatechit.tool.taxvoucher.DMucCTu;
...
public class ConfigInfo
{
    ...
    throws IOException, SAXException, ParserConfigurationException, GeneralSecurityException
  {
    ...
    rootCerts = CertVerifier.getCertificateList("certstore\\root");
    trustedCerts = CertVerifier.getCertificateList("certstore\\trust");
  }
